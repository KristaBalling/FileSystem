...
//            Path fileToMove = FileSystems.getDefault().getPath("Examples", "Dir1", "file1.txt");
//            Path destination = FileSystems.getDefault().getPath("Examples", "file1");
//            Files.move(fileToMove, destination);
//            Path sourceFile = FileSystems.getDefault().getPath("Examples","Dir1", "file1.txt");
